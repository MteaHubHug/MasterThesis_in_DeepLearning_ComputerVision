...
IMG_DIR2=conf.not_annotated_IRIIS_images_folder
...
##########################################################
def get_not_annotated_dict(json_dict,img_dir):
    new_dict={}
    for filename in json_dict["_via_img_metadata"]:
        inner_dict={}
        id = json_dict["_via_img_metadata"][filename]["filename"].split("/")[1].split("_")[0]  # id example : 41000103322-20210907T053847  # len(41000103322)=11 :(
...
#json_dict2=get_not_annotated_dict(json_dict,IMG_DIR2)
###########################################################
