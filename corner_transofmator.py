    ...
    for im in images:
        ...
        if(extension=="iriis.jpg"):
            ...
            if id in corners_dict:
                ...
                p1= ( iriis_x[0], iriis_y[0] )
                p2= ( iriis_x[1], iriis_y[1] )
                p3= ( iriis_x[2], iriis_y[2] )
                p4= ( iriis_x[3], iriis_y[3] )
            ...
            pts1 = np.float32([[  iriis_x[0]  , iriis_y[0]], [iriis_x[1], iriis_y[1]],
                               [iriis_x[2], iriis_y[2]], [ iriis_x[3], iriis_y[3] ]])
            pts2 = np.float32([[sirius_x[0], sirius_y[0]], [sirius_x[1], sirius_y[1]],
